...
import { findConfigPda, findPositionPda, findUsdcVaultPda } from "../pdas";
import { STOCK_VAULT_PROGRAM_ADDRESS } from "../programs";

export const BORROW_DISCRIMINATOR: ReadonlyUint8Array = new Uint8Array([
  228, 253, 131, 202, 207, 116, 89, 18,
]);

export function getBorrowDiscriminatorBytes(): ReadonlyUint8Array {
  return fixEncoderSize(getBytesEncoder(), 8).encode(BORROW_DISCRIMINATOR);
}
...
export function getBorrowInstructionDataDecoder(): FixedSizeDecoder<BorrowInstructionData> {
...
export function getBorrowInstructionDataCodec(): FixedSizeCodec<
  BorrowInstructionDataArgs,
  BorrowInstructionData
> {
  return combineCodec(
    getBorrowInstructionDataEncoder(),
    getBorrowInstructionDataDecoder(),
  );
}

export type BorrowAsyncInput<
...
> = {
  ...
  amount: BorrowInstructionDataArgs["amount"];
};
...
> {
  ...
  return Object.freeze({
    ...
    data: getBorrowInstructionDataEncoder().encode(
      args as BorrowInstructionDataArgs,
    ),
    programAddress,
  } as BorrowInstruction<
    TProgramAddress,
    ResolvedInstructionAccountMeta<
      TAccountOwner,
      InstructionAccountInputAddress<TAccountOwner>
...
export type ParsedBorrowInstruction<
  TProgram extends string = typeof STOCK_VAULT_PROGRAM_ADDRESS,
...
> = {
  ...
  accounts: {
    ...
    ownerUsdc: TAccountMetas[6];
    usdcVault: TAccountMetas[7];
    usdcTokenProgram: TAccountMetas[8];
  };
  data: BorrowInstructionData;
};

export function parseBorrowInstruction<
...
>(
  instruction: Instruction<TProgram> &
    ...
    InstructionWithData<ReadonlyUint8Array>,
): ParsedBorrowInstruction<TProgram, TAccountMetas> {
  ...
  return {
    ...
    data: getBorrowInstructionDataDecoder().decode(instruction.data),
  };
}
